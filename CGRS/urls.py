...
from CGRS_app.views import index, user_register,HOD,HODprofile,HODtable,HODnot, user_login,studentDashboard,studentGreivance,studentReports,studentUsers
